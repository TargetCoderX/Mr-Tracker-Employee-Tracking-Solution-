                                                                ...
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <div style="max-width: 570px;"><a
                                                                            ...
                                                                            target="_blank"><img alt="hero image"
                                                                                height="auto"
                                                                                src="{{ asset('mail_images/project_assigned_mail.png') }}"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    ...
                                                                    <span class="tinyMce-placeholder"
                                                                        ...
                                                                        <strong>{{ $user_data['first_name'] }}</strong>,</span>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">
                                                                        ...
                                                                        , where your role will be essential in
                                                                        achieving our goals. Your responsibilities
                                                                        include
                                                                        {{ $user_data['role_relation']['role_name'] }}.
                                                                        We’re
                                                                        confident your expertise will greatly contribute
                                                                        to the project’s success. If you have any
                                                                        questions, please feel free to reach out for
