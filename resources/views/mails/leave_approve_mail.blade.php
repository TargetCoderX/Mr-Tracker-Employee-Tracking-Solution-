...
<body class="body"
    style="margin: 0; background-color: #ecefe6; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
                            ...
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ecefe6; border-radius: 0; color: #000000; width: 1000px; margin: 0 auto;"
                                        width="1000">
                                        <tbody>
                                            <tr>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    ...
                                                                    <span class="tinyMce-placeholder"
                                                                        style="word-break: break-word;">hey
                                                                        <strong>liam</strong>,</span>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p>
                                                                        Kindly log in to the leave management system to
                                                                        review and process this request at your earliest
                                                                        convenience.
                                ...
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 30px; padding-top: 5px; vertical-align: middle; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                                    width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:5px;padding-left:20px;padding-right:20px;padding-top:5px;text-align:center;">
                                                                <div align="center" class="alignment"><!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.example.com" style="height:36px;width:241px;v-text-anchor:middle;" arcsize="56%" strokeweight="1.5pt" strokecolor="#AFC3A6" fill="false">
<w:anchorlock/>
...
<![endif]--><a href="{{ route('approve-leave', ['id' => $leave_id]) }}"
                                                                        ...
                                                                        target="_blank"><span
                                                                            style="word-break: break-word; padding-left: 20px; padding-right: 20px; font-size: 18px; display: inline-block; letter-spacing: 1px;"><span
                                                                                ...
                                                                                Leave
                                                                                Request</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
